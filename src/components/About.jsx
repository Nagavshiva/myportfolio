...
import aboutImg from "../assets/images/abouts.png";
const About = () => {
  const info = [
          ...
          <div className="p-2">
            <div className="text-gray-300 my-3">
              <p className="text-justify leading-7 w-11/12 mx-auto">
                Hello, my name is Naganathan and I am from Pudukkottai, Tamil
                Nadu. Aspiring full-stack web developer with a focus on the MERN
              ...
              <br />
              <br />
              <a href="/naganathan.pdf" target="_blank">
